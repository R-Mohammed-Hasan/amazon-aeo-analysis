  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-5 gap-12 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse, #6366F1 0%, #F59E0B 100%)",
        }}
      />
      ...
      <div className="flex flex-col items-center gap-4 text-center animate-fade-up">
        ...
        <p className="text-[var(--muted)] text-base max-w-sm leading-relaxed font-normal">
          ...
          <br className="hidden sm:block" />+ your AEO score across GPT, Claude
          &amp; Gemini.
        </p>
      </div>
      ...
      <form
        ...
        className="w-full max-w-lg flex flex-col gap-2.5 animate-fade-up delay-1"
      >
        ...
        {error && (
          <p className="text-[var(--critical)] text-xs pl-1">{error}</p>
        )}
      </form>
      ...
      <div className="grid grid-cols-2 gap-2.5 w-full max-w-lg animate-fade-up delay-2">
        {[
          ...
          >
            <span
              className="transition-transform group-hover:scale-110 w-fit"
      ...
      {/* Footer hint */}
      <p className="text-xs text-[var(--muted)] animate-fade-up delay-4">
